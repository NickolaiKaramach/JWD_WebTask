...
public final class FindAnswerByAnswerIdAndUserId {
    public static final String STATEMENT = "select  answers.isRight, answers.description from answers inner join questions q on answers.questions_id = q.id WHERE answers.id = ? and q.owner_id = ?;";
