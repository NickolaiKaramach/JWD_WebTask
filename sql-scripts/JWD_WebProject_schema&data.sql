...
(
    ...
    CONSTRAINT fk_choices_questions1 FOREIGN KEY (question_id) REFERENCES JWD_WebProject.questions (id),
    CONSTRAINT fk_choices_answers1 FOREIGN KEY (answer_id) REFERENCES JWD_WebProject.answers (id),
    CONSTRAINT fk_choices_grades1 FOREIGN KEY (grade_id) REFERENCES JWD_WebProject.grades (id)
);
